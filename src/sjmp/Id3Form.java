...
public class Id3Form extends javax.swing.JFrame  {
    ...
    private void showID3() {
        ...
        txtTrack.setText(current + " / " + list.size());
            ...
            txtTrack.setText("error saving ID3");
        }
    }
    ...
    private void saveEdit() {
        ...
        id3.setGenreString(cboGenre.getSelectedItem().toString());
        id3.writeTag();
    ...
    ArrayList list = action.getListSong();
    File mp3;
    String songtitle, artist, album, year, comment;
    ID3v1Tag id3;
    Player ply = new Player();
    JList listsong = ply.listSong;
    int song, timeshow;
    Timer timer = new Timer();
    int delay = 0;
    int period = 1000;
    NullsoftID3GenreTable id3genre = new NullsoftID3GenreTable();
    String[] genres = {"Blues","Classic Rock","Country","Dance","Disco","Funk",
    "General Fiction","Grunge","Hip-Hop","Jazz","Metal","New Age","Oldies",
